...
Most layout positioning is tied to the project [resolution](/creator/docs/projects/#resolution), so use assets that match or are relative to that resolution.
...
Upload images on the [Images](/creator/docs/images/) page before using them in a layout.
...
- [Line action: Choices](/creator/docs/line-actions/choices/)
