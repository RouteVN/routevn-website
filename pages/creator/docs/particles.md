...
Upload the texture image in the [Images](/creator/docs/images/) page first.

For full-screen effects, the particle canvas size should usually match or be relative to the project [resolution](/creator/docs/projects/#resolution).
...
For full-screen effects, width and height should usually match the project [resolution](/creator/docs/projects/#resolution).
