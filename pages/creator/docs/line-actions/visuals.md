...
Unlike [Background](/creator/docs/line-actions/background/), Visuals can have multiple items at the same time. Visuals stay on following lines until the Visuals action changes or removes them.

## Visual sources

Visuals can use 3 resource types:

- [Images](/creator/docs/images/)
- [Videos](/creator/docs/videos/)
...
Use Transform to apply a reusable [transform](/creator/docs/transforms/) to the visual.

Transforms can change the visual position, scale, rotation, and anchor.

## Animations

Animation controls whether the visual uses an [animation](/creator/docs/animations/).
