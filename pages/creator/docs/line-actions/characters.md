...
Characters lets you place [character sprites](/creator/docs/characters/#character-sprites) on screen.
...
2. Select a [character](/creator/docs/characters/).
...
If the character uses [sprite groups](/creator/docs/characters/#sprite-groups), select one sprite for each group before clicking `Select`.

Double click a sprite in the selector to preview it at a larger size.

## Transform

Use Transform to apply a reusable [transform](/creator/docs/transforms/) to the character sprite.

Transforms can change the sprite position, scale, rotation, and anchor.

## Animations

Animation controls whether the character sprite uses an [animation](/creator/docs/animations/).
...
Sprite groups appear when the selected character has groups configured on the [Characters](/creator/docs/characters/#sprite-groups) page.
