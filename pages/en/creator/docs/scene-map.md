...
- Mouse: You can scroll up and down to zoom in and out.
- Touch interfaces: Pinch in and out to zoom.
...
Right click on the canvas to create a scene.

The position where you right click will indicate the place where the scene node will be added.
