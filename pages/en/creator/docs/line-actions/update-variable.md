...
Update Variable changes one or more [variables](/en/creator/docs/variables/) when the action runs.
...
- [Layout editor](/en/creator/docs/layouts/#layout-editor) interaction actions.
