...
- Video dimensions should match or be relative to the project [resolution](/en/creator/docs/projects/#resolution).
...
The Videos page inherits the general [File Explorer keyboard shortcuts](/en/creator/docs/file-explorer/#keyboard-shortcuts).
