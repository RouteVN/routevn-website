...
Read more in [Add dialogue speaker](/en/creator/docs/line-actions/dialogue/#add-dialogue-speaker).
...
- The sprites page works the same as the [Images page](/en/creator/docs/images/), but all image sprites are attached to the character.
