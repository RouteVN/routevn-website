...
seo:
  title: Designing RouteVN's Brand Identity
  description: A behind-the-scenes writeup about RouteVN's brand identity refresh, including the logo, app icon, website, mascot, and illustration direction.
  ogType: article
  ogImage: https://routevn.com/public/blog/2026/12/routevn-brand-identity-og.png
  ogImageWidth: 1200
  ogImageHeight: 630
  ogImageAlt: RouteVN brand identity preview with Makkuro and the RouteVN logo
...
- We made her live up to her name, so we made her hair and outfit fully black. This led us to use non-black lines.
- We stuck with cel shading for coloring. It is less time-consuming than a full render, while still feeling simple and elegant.
- She is left-handed.
- Her hairpin is a small accessory that makes her stand out. The Y shape represents a path branching into two different routes.
...
- We played with the idea of choices, like the old icon.
- We tried to represent routes as a path branching into two paths.
- We explored variations of the letter `r` or `R`.

But none of them really clicked with us. Some candidates were better than others, but they felt too dependent on typography.
...
- Drawing paper and a drawing tablet.
- A pen and notebook for writing.
- An electric piano keyboard for music.
- A recording microphone for voice acting.
...
- We can use them in the RouteVN Discord server.
- We can print them as physical merchandise.
- We can also place them on the website to make pages feel more lively than plain text.
...
[@RE_0rie](https://x.com/RE_0rie) is the artist who worked on the Makkuro stickers.
...
<video src="/public/blog/2026/12/website-refresh.mp4" autoplay loop muted playsinline style="width: 100%; max-width: 100%; margin-bottom: 24px; border: 1px solid var(--border); box-sizing: border-box;"></video>
