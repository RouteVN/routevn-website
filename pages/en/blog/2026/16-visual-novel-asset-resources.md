...
Pre-made assets can help when:

- You need placeholders to establish the look and feel of your visual novel, get feedback quickly, and replace the assets later.
- You can write the story but cannot create the artwork or find an artist to work with.
- You plan to create most of the art yourself but need pre-made backgrounds for locations that are not critical to the story.
- You cannot make music or sound effects, so you want to browse pre-made audio that suits your story.

This list introduces places where you can find free and paid assets for your project. It is a starting point, not a replacement for reading each asset's license.
...
- [Free visual novel assets](https://itch.io/game-assets/free/genre-visual-novel)
- [Free visual novel backgrounds](https://itch.io/game-assets/free/genre-visual-novel/tag-backgrounds)

Both free and paid assets are available. The creator of each asset sets its license, so read the asset page and any included license files before using it.
...
- [Background images](https://booth.pm/en/browse/Background%20Images?in_stock=true&sort=new&type=digital)
- [Background music](https://booth.pm/en/browse/Background%20Music?in_stock=true&sort=new&type=digital)
...
The resources can be used without a usage fee or mandatory credit under the site's standard terms. Read the [sound license](https://dova-s.jp/contents/license) and any notes attached to an individual track before using it.
