...
Alongside the new features, we also released [40 pages of documentation](/en/creator/docs/introduction/) to help users learn how to use the application. This is part of the initiative to make RouteVN Creator easier to use.
