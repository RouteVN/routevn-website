...
RouteVN develops both the Creator application and the underlying Route Engine in smaller, faster steps. Expect roughly [weekly releases](/en/creator/changelog/): the Creator client had 18 releases in the first half of 2026, and the underlying [Route Engine](https://github.com/RouteVN/route-engine/releases) is released even more often, with more than 130 releases in 2026 so far. Ren'Py and Route Engine release counts are not directly comparable, since projects structure and publish releases differently, but the difference in pace is clear.
